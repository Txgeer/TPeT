function loadVue() {
    ...
    app.component('bar', {
        ...
        template: `
        <div v-if="tmp[layer] && tmp[layer].bars && tmp[layer].bars[data] && run(tmp[layer].bars[data].unlocked, layers[layer].bars[data])"d" :style="{'position': 'relative'}"><div :style="[tmp[layer].bars[data].style, style.dims, {'display': 'table'}]">
